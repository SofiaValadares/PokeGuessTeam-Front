...
export const GACHA_POKEBALLS: PokeballGachaOption[] = [
  ...
  { type: 'GREAT_BALL', spriteSrc: '/pokeboll/greatboll.png', label: 'Great Ball' },
  { type: 'ULTRA_BALL', spriteSrc: '/pokeboll/ultraboll.png', label: 'Ultra Ball' },
  { type: 'MASTER_BALL', spriteSrc: '/pokeboll/masterboll.png', label: 'Master Ball' },
];
